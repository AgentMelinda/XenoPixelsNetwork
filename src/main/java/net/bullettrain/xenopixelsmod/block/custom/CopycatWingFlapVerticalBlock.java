...
/** Texture-inheriting {@link WingFlapVerticalBlock} — see {@link CopycatWingPanelBlock}. */
public class CopycatWingFlapVerticalBlock extends WingFlapVerticalBlock implements CopycatWing {

    public static final MapCodec<CopycatWingFlapVerticalBlock> CODEC =
            simpleCodec(CopycatWingFlapVerticalBlock::new);

    public CopycatWingFlapVerticalBlock(Properties properties) {
        super(properties);
    }
