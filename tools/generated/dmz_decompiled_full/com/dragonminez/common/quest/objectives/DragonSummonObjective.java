...
public class DragonSummonObjective extends QuestObjective {
   ...
   public DragonSummonObjective(String dragonId, String ballSetId) {
      super(QuestObjective.ObjectiveType.DRAGON_SUMMON, 1);
   ...
   public boolean matches(String summonedDragonId, String summonedBallSetId) {
      ...
      return matchesField(this.dragonId, normalizedDragonId) && matchesField(this.ballSetId, normalizedBallSetId);
   }
   ...
   public boolean checkProgress(Object... params) {
      if (params.length >= 2
         ...
         && this.matches(summonedDragonId, summonedBallSetId)) {
         this.setProgress(1);
         return true;
      } else {
         return false;
