         ...
         .enqueueWork(
            () -> {
               ...
               if (player != null) {
                  ...
                  DragonWishEntity dragon = (DragonWishEntity)level.getEntitiesOfClass(
                        DragonWishEntity.class,
                  ...
                  if (dragon != null) {
                     ...
                     if (definition != null) {
                        ...
                        if (allWishes != null && !allWishes.isEmpty()) {
                           ...
                           for (int index : new LinkedHashSet<>(this.selectedWishIndices)) {
                              if (wishesToGrant.size() >= maxWishes) {
                                 break;
                              }
