            ...
            StatsProvider.get(StatsCapability.INSTANCE, player).ifPresent(data -> {
               if (msg.customHair != null) {
                  switch (msg.hairIndex) {
                     case 1:
                        data.getCharacter().setHairSSJ(msg.customHair);
                        break;
                     case 2:
                        data.getCharacter().setHairSSJ2(msg.customHair);
                        break;
                     case 3:
                        data.getCharacter().setHairSSJ3(msg.customHair);
                        break;
                     default:
                        data.getCharacter().setHairBase(msg.customHair);
                  }
