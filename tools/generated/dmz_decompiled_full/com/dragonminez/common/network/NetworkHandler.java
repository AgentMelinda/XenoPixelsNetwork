...
public class NetworkHandler {
   ...
   public static void register() {
      SimpleChannel net = NetworkRegistry.ChannelBuilder.named(ResourceLocation.fromNamespaceAndPath("dragonminez", "network"))
      ...
      net.messageBuilder(TechniqueChargeC2S.class, id(), NetworkDirection.PLAY_TO_SERVER)
         ...
         .add();
      net.messageBuilder(StrikeAttackC2S.class, id(), NetworkDirection.PLAY_TO_SERVER)
         .decoder(StrikeAttackC2S::new)
         .encoder(StrikeAttackC2S::toBytes)
         .consumerMainThread(StrikeAttackC2S::handle)
         .add();
      ...
      net.messageBuilder(ProgressionSyncS2C.class, id(), NetworkDirection.PLAY_TO_CLIENT)
         ...
         .add();
      net.messageBuilder(TechniqueChargeSyncS2C.class, id(), NetworkDirection.PLAY_TO_CLIENT)
         .decoder(TechniqueChargeSyncS2C::decode)
         .encoder(TechniqueChargeSyncS2C::encode)
         .consumerMainThread(TechniqueChargeSyncS2C::handle)
         .add();
