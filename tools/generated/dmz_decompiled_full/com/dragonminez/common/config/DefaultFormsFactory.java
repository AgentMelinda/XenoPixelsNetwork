...
public class DefaultFormsFactory {
   ...
   public void createDefaultFormsForRace(String raceName, Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      switch (var4) {
         case "human":
            this.createDefaultHumanForms(formsPath, forms);
            break;
         case "saiyan":
            this.createSaiyanForms(formsPath, forms);
            break;
         case "namekian":
            this.createNamekianForms(formsPath, forms);
            break;
         case "frostdemon":
            this.createFrostDemonForms(formsPath, forms);
            break;
         case "majin":
            this.createMajinForms(formsPath, forms);
            break;
         case "bioandroid":
            this.createBioAndroidForms(formsPath, forms);
      }
   }

   public void createDefaultStackForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      this.createDefaultKaiokenForms(formsPath, forms);
      this.createDefaultUltimateForms(formsPath, forms);
   }
   ...
   public void createDefaultKaiokenForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      kaiokenForms.setConfigVersion("2.1.3");
      kaiokenForms.setGroupName("kaioken");
      kaiokenForms.setFormType("kaioken");
      ...
      x2.setHairType("");
      this.setDefaultMasteryValues(x2);
      x2.setAuraLayer(1);
      x2.setStackOnMastery(0.0);
      x2.setShareMasteryWith(List.of("kaioken.x3"));
      ...
      x3.setHairType("");
      this.setDefaultMasteryValues(x3);
      x3.setAuraLayer(1);
      x3.setStackOnMastery(0.0);
      x3.setShareMasteryWith(List.of("kaioken.x4"));
      ...
      x4.setHairType("");
      this.setDefaultMasteryValues(x4);
      x4.setAuraLayer(1);
      x4.setStackOnMastery(0.0);
      x4.setShareMasteryWith(List.of("kaioken.x10"));
      ...
      x10.setHairType("");
      this.setDefaultMasteryValues(x10);
      x10.setAuraLayer(1);
      x10.setStackOnMastery(0.0);
      x10.setShareMasteryWith(List.of("kaioken.x20"));
      ...
      x20.setHairType("");
      this.setDefaultMasteryValues(x20);
      x20.setAuraLayer(1);
      x20.setStackOnMastery(0.0);
      x20.setShareMasteryWith(List.of("kaioken.x100"));
   ...
   public void createDefaultUltimateForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      ultimateForms.setConfigVersion("2.1.3");
      ultimateForms.setGroupName("ultimate");
      ultimateForms.setFormType("ultimate");
      ...
      Map<String, FormConfig.FormData> stackFormData = new LinkedHashMap<>();
      stackFormData.put("ultimate", ultimate);
      ultimateForms.setForms(stackFormData);
      forms.put("ultimate", ultimateForms);
   ...
   public void createDefaultUltraInstinctForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      ultraInstinctForms.setConfigVersion("2.1.3");
      ultraInstinctForms.setGroupName("ultrainstinct");
      ultraInstinctForms.setFormType("ultrainstinct");
      ...
      sign.setHairType("");
      this.setDefaultMasteryValues(sign);
      ...
      this.setDefaultMasteryValues(mastered);
      mastered.setStackDrainMultiplier(1.0);
      mastered.setAllowFreeTransformOnMastery(0.0);
      Map<String, FormConfig.FormData> stackFormData = new LinkedHashMap<>();
      stackFormData.put("sign", sign);
      stackFormData.put("mastered", mastered);
      ultraInstinctForms.setForms(stackFormData);
      forms.put("ultrainstinct", ultraInstinctForms);
   ...
   public void createDefaultUltraEgoForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      ultraEgoForms.setConfigVersion("2.1.3");
      ultraEgoForms.setGroupName("ultraego");
      ultraEgoForms.setFormType("ultraego");
      FormConfig.FormData sign = new FormConfig.FormData();
      sign.setName("sign");
      sign.setUnlockOnSkillLevel(1);
      sign.setStrMultiplier(1.5);
      ...
      forms.put("ultraego", ultraEgoForms);
   ...
   private void createDefaultHumanForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      humanForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(buffed);
      ...
      this.setDefaultMasteryValues(fullPower);
      ...
      this.setDefaultMasteryValues(overdrive);
      ...
      this.setDefaultMasteryValues(solaris);
      ...
      this.applySequentialMasteryRequisites("superforms", humanFormData);
      ...
      humanLegendaryForms.setConfigVersion("2.1.3");
      humanLegendaryForms.setGroupName("legendaryforms");
      humanLegendaryForms.setFormType("legendaryforms");
      FormConfig.FormData shiyoken = new FormConfig.FormData();
      shiyoken.setName("shiyoken");
      ...
      this.setDefaultMasteryValues(shiyoken);
      ...
      shin_shiyoken.setName("shin_shiyoken");
      ...
      this.setDefaultMasteryValues(shin_shiyoken);
      ...
      chou_shiyokenOutline.setOutlineThickness(3.7);
      chou_shiyoken.setOutlineShader(chou_shiyokenOutline);
      chou_shiyoken.setName("chou_shiyoken");
      ...
      this.setDefaultMasteryValues(chou_shiyoken);
      ...
      humanLegendaryData.put("shiyoken", shiyoken);
      humanLegendaryData.put("shin_shiyoken", shin_shiyoken);
      humanLegendaryData.put("chou_shiyoken", chou_shiyoken);
      this.applySequentialMasteryRequisites("legendaryforms", humanLegendaryData);
      humanLegendaryForms.setForms(humanLegendaryData);
      forms.put("legendaryforms", humanLegendaryForms);
      LogUtil.info(Env.COMMON, "Default Human legendary forms created");
      this.createAndroidForms(formsPath, forms);
   }
   ...
   private void createAndroidForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      androidForms.setConfigVersion("2.1.3");
      androidForms.setGroupName("androidforms");
      androidForms.setFormType("androidforms");
      FormConfig.FormData androidBase = new FormConfig.FormData();
      androidBase.setName("androidbase");
      ...
      this.setDefaultMasteryValues(androidBase);
      ...
      superAndroid.setName("superandroid");
      ...
      this.setDefaultMasteryValues(fusedAndroid);
      fusedAndroid.setStackDrainMultiplier(2.0);
      Map<String, FormConfig.FormData> androidFormData = new LinkedHashMap<>();
      androidFormData.put("androidbase", androidBase);
      androidFormData.put("superandroid", superAndroid);
      androidFormData.put("fusedandroid", fusedAndroid);
      this.applySequentialMasteryRequisites("androidforms", androidFormData);
      androidForms.setForms(androidFormData);
      forms.put("androidforms", androidForms);
   ...
   private void createSaiyanForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      oozaruForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(oozaru);
      ...
      this.setDefaultMasteryValues(goldenOozaru);
      ...
      this.setDefaultMasteryValues(ssj4gt);
      ...
      oozaruFormData.put("supersaiyan4", ssj4gt);
      this.applySequentialMasteryRequisites("oozaru", oozaruFormData);
      oozaruForms.setForms(oozaruFormData);
      FormConfig ssGrades = new FormConfig();
      ssGrades.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(ssj1);
      ...
      this.setDefaultMasteryValues(ssg2);
      ...
      this.setDefaultMasteryValues(ssg3);
      ...
      ssGradeForms.put("supersaiyan", ssj1);
      ssGradeForms.put("supersaiyangrade2", ssg2);
      ssGradeForms.put("supersaiyangrade3", ssg3);
      this.applySequentialMasteryRequisites("ssgrades", ssGradeForms);
      ssGrades.setForms(ssGradeForms);
      FormConfig superSaiyan = new FormConfig();
      superSaiyan.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(ssj1Mastered);
      ...
      this.setDefaultMasteryValues(ssj2);
      ...
      this.setDefaultMasteryValues(ssj3);
      ...
      ssj4dOutline.setOutlineThickness(3.7);
      ssj4d.setOutlineShader(ssj4dOutline);
      ssj4d.setName("supersaiyan4");
      ...
      this.setDefaultMasteryValues(ssj4d);
      ...
      superSaiyanForms.put("supersaiyanmastered", ssj1Mastered);
      superSaiyanForms.put("supersaiyan2", ssj2);
      superSaiyanForms.put("supersaiyan3", ssj3);
      superSaiyanForms.put("supersaiyan4", ssj4d);
      this.applySequentialMasteryRequisites("supersaiyan", superSaiyanForms);
      ...
      saiyanLegendaryForms.setConfigVersion("2.1.3");
      saiyanLegendaryForms.setGroupName("legendaryforms");
      ...
      ikariOutline.setOutlineThickness(3.5);
      ...
      this.setDefaultMasteryValues(ikari);
      ...
      this.setDefaultMasteryValues(ssjFullPower);
      ssjFullPower.setStackDrainMultiplier(2.0);
      Map<String, FormConfig.FormData> saiyanLegendaryData = new LinkedHashMap<>();
      saiyanLegendaryData.put("ikari", ikari);
      saiyanLegendaryData.put("ssjhybrid", ssjHybrid);
      saiyanLegendaryData.put("ssjfullpower", ssjFullPower);
      this.applySequentialMasteryRequisites("legendaryforms", saiyanLegendaryData);
      saiyanLegendaryForms.setForms(saiyanLegendaryData);
      forms.put("legendaryforms", saiyanLegendaryForms);
   ...
   private void createNamekianForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      namekianForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(giantForm);
      ...
      this.setDefaultMasteryValues(superNamekian);
      ...
      this.applySequentialMasteryRequisites("superforms", namekianFormData);
      ...
      namekianLegendaryForms.setConfigVersion("2.1.3");
      namekianLegendaryForms.setGroupName("legendaryforms");
      namekianLegendaryForms.setFormType("legendaryforms");
      FormConfig.FormData evilNamek = new FormConfig.FormData();
      evilNamek.setName("evilnamek");
      ...
      this.setDefaultMasteryValues(evilNamek);
      ...
      evilGiant.setName("evilgiantnamek");
      ...
      this.setDefaultMasteryValues(evilGiant);
      ...
      buffedNamekOutline.setOutlineThickness(3.5);
      buffedNamek.setOutlineShader(buffedNamekOutline);
      buffedNamek.setName("buffednamek");
      ...
      this.setDefaultMasteryValues(buffedNamek);
      buffedNamek.setStackDrainMultiplier(2.0);
      Map<String, FormConfig.FormData> namekianLegendaryData = new LinkedHashMap<>();
      namekianLegendaryData.put("evilnamek", evilNamek);
      namekianLegendaryData.put("evilgiantnamek", evilGiant);
      namekianLegendaryData.put("buffednamek", buffedNamek);
      this.applySequentialMasteryRequisites("legendaryforms", namekianLegendaryData);
      namekianLegendaryForms.setForms(namekianLegendaryData);
      forms.put("legendaryforms", namekianLegendaryForms);
   ...
   private void createFrostDemonForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      frostForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(second);
      ...
      this.setDefaultMasteryValues(third);
      ...
      this.setDefaultMasteryValues(finalForm);
      ...
      this.setDefaultMasteryValues(fifthForm);
      ...
      frostFormData.put("fifth", fifthForm);
      this.applySequentialMasteryRequisites("evolutionforms", frostFormData);
      ...
      frostLegendaryForms.setConfigVersion("2.1.3");
      frostLegendaryForms.setGroupName("legendaryforms");
      ...
      this.setDefaultMasteryValues(mecha);
      ...
      this.setDefaultMasteryValues(metalCore);
      metalCore.setStackDrainMultiplier(2.0);
      Map<String, FormConfig.FormData> frostLegendaryData = new LinkedHashMap<>();
      frostLegendaryData.put("mecha", mecha);
      frostLegendaryData.put("metal", metal);
      frostLegendaryData.put("metalcore", metalCore);
      this.applySequentialMasteryRequisites("legendaryforms", frostLegendaryData);
      frostLegendaryForms.setForms(frostLegendaryData);
      forms.put("legendaryforms", frostLegendaryForms);
   ...
   private void createMajinForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      majinForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(kid);
      ...
      this.setDefaultMasteryValues(evil);
      ...
      this.setDefaultMasteryValues(superForm);
      ...
      this.setDefaultMasteryValues(ultra);
      ...
      this.applySequentialMasteryRequisites("pureforms", majinFormData);
      ...
      majinLegendaryForms.setConfigVersion("2.1.3");
      majinLegendaryForms.setGroupName("legendaryforms");
      majinLegendaryForms.setFormType("legendaryforms");
      FormConfig.FormData innocence = new FormConfig.FormData();
      innocence.setName("innocencedemon");
      ...
      this.setDefaultMasteryValues(innocence);
      ...
      giant_innocence_demon.setName("giantinnocencedemon");
      ...
      this.setDefaultMasteryValues(superDemon);
      superDemon.setStackDrainMultiplier(2.0);
      Map<String, FormConfig.FormData> majinLegendaryData = new LinkedHashMap<>();
      majinLegendaryData.put("innocencedemon", innocence);
      majinLegendaryData.put("giantinnocencedemon", giant_innocence_demon);
      majinLegendaryData.put("superdemon", superDemon);
      this.applySequentialMasteryRequisites("legendaryforms", majinLegendaryData);
      majinLegendaryForms.setForms(majinLegendaryData);
      forms.put("legendaryforms", majinLegendaryForms);
   ...
   private void createBioAndroidForms(Path formsPath, Map<String, FormConfig> forms) throws IOException {
      ...
      bioForms.setConfigVersion("2.1.3");
      ...
      this.setDefaultMasteryValues(semiPerfect);
      ...
      this.setDefaultMasteryValues(perfect);
      ...
      this.setDefaultMasteryValues(superPerfect);
      ...
      ultraperfect.setName("ultraperfect");
      ...
      this.setDefaultMasteryValues(ultraperfect);
      ...
      bioFormData.put("ultraperfect", ultraperfect);
      this.applySequentialMasteryRequisites("bioevolution", bioFormData);
      ...
      bioLegendaryForms.setConfigVersion("2.1.3");
      bioLegendaryForms.setGroupName("legendaryforms");
      ...
      this.setDefaultMasteryValues(xeno);
      ...
      this.setDefaultMasteryValues(xenoFP);
      ...
      this.setDefaultMasteryValues(xenoMax);
      ...
      bioLegendaryData.put("xeno", xeno);
      bioLegendaryData.put("xenofp", xenoFP);
      bioLegendaryData.put("xenomax", xenoMax);
      this.applySequentialMasteryRequisites("legendaryforms", bioLegendaryData);
      bioLegendaryForms.setForms(bioLegendaryData);
      forms.put("legendaryforms", bioLegendaryForms);
