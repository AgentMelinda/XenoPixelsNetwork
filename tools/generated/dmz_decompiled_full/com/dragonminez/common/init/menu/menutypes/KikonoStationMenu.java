...
public class KikonoStationMenu extends AbstractContainerMenu {
   ...
   public KikonoStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
      super((MenuType)MainMenus.KIKONO_STATION_MENU.get(), pContainerId);
      ...
      this.addSlot(new SlotItemHandler(handler, 9, 89, 17));
      this.addSlot(new SlotItemHandler(handler, 10, 89, 53));
      this.addSlot(new SlotItemHandler(handler, 11, 141, 35));
   ...
   public ItemStack quickMoveStack(Player playerIn, int pIndex) {
      ...
      if (sourceSlot != null && sourceSlot.hasItem()) {
         ...
         if (pIndex < 36) {
            if (!this.moveItemStackTo(sourceStack, 36, 48, false)) {
   ...
   public boolean stillValid(Player pPlayer) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), pPlayer, (Block)MainBlocks.KIKONO_STATION.get());
   }
