...
public class FuelGeneratorMenu extends AbstractContainerMenu {
   ...
   public FuelGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
      super((MenuType)MainMenus.FUEL_GENERATOR_MENU.get(), pContainerId);
      ...
      this.addSlot(new SlotItemHandler(this.blockEntity.getItemHandler(), 0, 80, 38));
   ...
   public int getScaledBurnTime() {
      ...
      int flameSize = 14;
      return maxBurnTime == 0 ? 0 : (maxBurnTime - burnTime) * flameSize / maxBurnTime;
   }
   ...
   public boolean stillValid(Player pPlayer) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), pPlayer, (Block)MainBlocks.FUEL_GENERATOR.get());
   }
