...
public final class MainSounds {
   public static final DeferredRegister<SoundEvent> SOUND_EVENTS_REGISTER = DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, "dragonminez");
   ...
   private static DeferredHolder<SoundEvent, ? extends SoundEvent> registerSoundEvent(String name) {
      ResourceLocation id = ResourceLocation.fromNamespaceAndPath("dragonminez", name);
