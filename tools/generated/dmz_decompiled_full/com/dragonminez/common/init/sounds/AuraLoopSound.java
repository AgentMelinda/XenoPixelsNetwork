...
public class AuraLoopSound extends AbstractTickableSoundInstance {
   ...
   public AuraLoopSound(Player player) {
      super((SoundEvent)MainSounds.KI_CHARGE_LOOP.get(), SoundSource.PLAYERS, SoundInstance.createUnseededRandom());
      this.player = player;
      this.looping = true;
      this.delay = 0;
      this.volume = 0.5F;
   ...
   public void tick() {
      if (this.player.isRemoved()) {
         ...
         StatsData stats = StatsProvider.get(StatsCapability.INSTANCE, this.player).orElse(null);
