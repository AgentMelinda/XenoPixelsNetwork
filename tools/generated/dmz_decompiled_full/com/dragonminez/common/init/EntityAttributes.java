...
public class EntityAttributes {
   ...
   public static final DeferredHolder<Attribute, Attribute> KI_BLAST_DAMAGE = register(
      "ki_blast_damage", "attribute.dragonminez.ki_blast_damage", 20.0, 0.0, 2.0E9
   );
   ...
   public static final DeferredHolder<Attribute, Attribute> KI_BLAST_SPEED = register(
      "ki_blast_speed", "attribute.dragonminez.ki_blast_speed", 0.6, 0.0, 1024.0
   );
