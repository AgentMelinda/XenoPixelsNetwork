...
public class AllMastersEntity {
   ...
   public static class MasterEnmaEntity extends MastersEntity {
      ...
      public void tick() {
         super.tick();
         if (this.getYRot() != 180.0F) {
            this.setYRot(180.0F);
         }

         if (this.getYHeadRot() != 180.0F) {
            this.setYHeadRot(180.0F);
         }

         if (this.yBodyRot != 180.0F) {
            this.yBodyRot = 180.0F;
         }

         if (this.yHeadRot != 180.0F) {
   ...
   public static class MasterGuruEntity extends MastersEntity {
      ...
      public void tick() {
         super.tick();
         if (this.getYRot() != 90.0F) {
            this.setYRot(90.0F);
         }

         if (this.getYHeadRot() != 90.0F) {
            this.setYHeadRot(90.0F);
         }

         if (this.yBodyRot != 90.0F) {
            this.yBodyRot = 90.0F;
         }

         if (this.yHeadRot != 90.0F) {
            this.yHeadRot = 90.0F;
         }
      }
   }
