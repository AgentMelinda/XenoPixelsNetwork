...
public class KiExplosionFlashParticle extends TextureSheetParticle {
   ...
   protected KiExplosionFlashParticle(
      ClientLevel level, double x, double y, double z, double entityIdAsDouble, double colorData, double sizeData, SpriteSet spriteSet
   ) {
   ...
   public void tick() {
      ...
      if (this.targetEntity != null && this.targetEntity.isAlive()) {
         ...
         this.yo = this.y;
         this.zo = this.z;
         this.setPos(this.targetEntity.getX(), this.targetEntity.getY(), this.targetEntity.getZ());
