...
public class HTCDimension {
   public static final ResourceKey<Level> HTC_KEY = ResourceKey.create(
      Registries.DIMENSION, ResourceLocation.fromNamespaceAndPath("dragonminez", "time_chamber")
   );
   public static final ResourceKey<DimensionType> HTC_TYPE = ResourceKey.create(
      Registries.DIMENSION_TYPE, ResourceLocation.fromNamespaceAndPath("dragonminez", "time_chamber")
   );
