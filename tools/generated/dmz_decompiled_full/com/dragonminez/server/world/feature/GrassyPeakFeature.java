...
public class GrassyPeakFeature extends RockyPeakFeature {
   public GrassyPeakFeature(Codec<NoneFeatureConfiguration> codec) {
      super(codec);
   }

   @Override
   protected BlockState capState() {
      return ((Block)MainBlocks.SACRED_PLANET_GRASS_BLOCK.get()).defaultBlockState();
   }
