...
public class NamekPlacedFeatures {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> context) {
      ...
      register(
         context,
         NAMEK_COAL_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_COAL_ORE),
         commonOrePlacement(30, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)))
      );
      register(
         context,
         NAMEK_COPPER_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_COPPER_ORE),
         commonOrePlacement(20, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(128)))
      );
      register(
         context,
         NAMEK_IRON_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_IRON_ORE),
         commonOrePlacement(20, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(128)))
      );
      register(
         context,
         NAMEK_GOLD_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_GOLD_ORE),
         commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(32)))
      );
      register(
         context,
         NAMEK_REDSTONE_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_REDSTONE_ORE),
         commonOrePlacement(8, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(16)))
      );
      register(
         context,
         NAMEK_EMERALD_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_EMERALD_ORE),
         commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(128)))
      );
      register(
         context,
         NAMEK_LAPIS_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_LAPIS_ORE),
         commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(64)))
      );
      register(
         context,
         NAMEK_DIAMOND_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_DIAMOND_ORE),
         commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(16)))
      );
      register(
         context,
         NAMEK_KIKONO_ORE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_KIKONO_ORE),
         commonOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(32)))
      );
      register(
         context,
         NAMEK_GETE_DEBRIS_LARGE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_GETE_DEBRIS_LARGE),
         commonOrePlacement(1, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-16)))
      );
      register(
         context,
         NAMEK_GETE_DEBRIS_SMALL_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_GETE_DEBRIS_SMALL),
         commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-16)))
      );
      register(
         context,
         AJISSA_TREE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.AJISSA_TREE),
         VegetationPlacements.treePlacement(PlacementUtils.countExtra(1, 0.1F, 1), (Block)MainBlocks.NAMEK_AJISSA_SAPLING.get())
      );
      register(
         context,
         SACRED_TREE_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.SACRED_TREE),
         VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.05F, 1), (Block)MainBlocks.NAMEK_SACRED_SAPLING.get())
      );
      register(
         context,
         NAMEK_LAKE_LAVA_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_LAKE_LAVA),
      ...
      register(
         context,
         NAMEK_SPRING_LAVA_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_SPRING_LAVA),
      ...
      register(
         context,
         NAMEK_SPRING_WATER_PLACED,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_SPRING_WATER),
      ...
      register(
         context,
         NAMEK_PATCH_GRASS_PLAIN,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_PATCH_GRASS_KEY),
      ...
      register(
         context,
         NAMEK_PLAINS_FLOWERS,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_FLOWERS_KEY),
         ImmutableList.builder()
      ...
      register(
         context,
         NAMEK_PATCH_SACRED_GRASS_PLAIN,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_PATCH_SACRED_GRASS_KEY),
         ImmutableList.builder()
            .add(NoiseThresholdCountPlacement.of(-0.8F, 5, 10))
            .add(InSquarePlacement.spread())
            .add(HeightmapPlacement.onHeightmap(Types.WORLD_SURFACE_WG))
      ...
      register(
         context,
         NAMEK_SACRED_FLOWERS,
         configured.getOrThrow(NamekConfiguredFeatures.NAMEK_SACRED_FLOWERS_KEY),
         ImmutableList.builder()
            .add(NoiseThresholdCountPlacement.of(-0.8F, 15, 4))
            .add(RarityFilter.onAverageOnceEvery(12))
            .add(InSquarePlacement.spread())
