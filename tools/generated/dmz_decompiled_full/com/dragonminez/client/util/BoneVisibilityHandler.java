...
public class BoneVisibilityHandler {
   public static void updateVisibility(BakedGeoModel model, AbstractClientPlayer player, GeoRenderLayer<?> renderLayer) {
      ...
      if (stats != null) {
         if (shouldShowBodyOnly(renderLayer, player)) {
            ...
            boolean isFemale = gender.equals("female") || bodyType == 1;
            ...
            boolean isSuperOrUltra = Objects.equals(currentForm, "super") || Objects.equals(currentForm, "ultra");
            ...
            model.getBone("tail1")
               .ifPresent(
                  bone -> {
                     if (!logicKey.equals("janemba_super")) {
                        ...
                        if (currentForm.contains("supersaiyan4") || logicKey.contains("ssj4")) {
                           ...
                           if (!isTaillessRace && !isTaillessModel) {
                              showNormalTail = true;
                           } else {
   ...
   public static boolean hasModerfokinArmor(AbstractClientPlayer player) {
      ...
      return !stack.isEmpty() && stack.getItem() instanceof ArmorItem ? stack.getItem() instanceof DbzArmorTextured : false;
   }
   ...
   public static void applyBodyOnlyVisibility(BakedGeoModel model) {
      ...
      model.getBone("body").ifPresent(body -> {
         ...
         for (GeoBone parent = body.getParent(); parent != null; parent = parent.getParent()) {
