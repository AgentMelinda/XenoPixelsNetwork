...
public class BaseAnimations {
   ...
   public static final RawAnimation FUSION_DANCE_RIGHT = RawAnimation.begin().thenPlayAndHold("base.fusion_dance_right");
   public static final RawAnimation FUSION_DANCE_LEFT = RawAnimation.begin().thenPlayAndHold("base.fusion_dance_left");
   public static final RawAnimation FUSION_POTHALA_RIGHT = RawAnimation.begin().thenLoop("base.fusion_pothala_right");
   public static final RawAnimation FUSION_POTHALA_LEFT = RawAnimation.begin().thenLoop("base.fusion_pothala_left");
