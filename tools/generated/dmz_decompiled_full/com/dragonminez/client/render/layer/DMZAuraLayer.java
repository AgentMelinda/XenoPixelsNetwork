   ...
   public void render(
      ...
      if (!animatable.isSpectator()) {
         ...
         if (stats != null) {
            ...
            boolean isAndroidChargingForm = stats.getStatus().isAndroidUpgraded()
               && stats.getStatus().isActionCharging()
               && stats.getStatus().getSelectedAction() == ActionMode.FORM;
            ...
            if (!stats.getStatus().isAndroidUpgraded() || isAndroidChargingForm || hasLightning) {
               if (isAuraActive && !isAndroidChargingForm) {
                  PlayerEffectQueue.addAura(animatable, playerModel, poseStack, partialTick, packedLight);
               }
