...
public final class GravityRedManager {
   private static final ResourceLocation EFFECT = ResourceLocation.fromNamespaceAndPath("dragonminez", "shaders/post/gravity_red.json");
      ...
      if (mc.level != null) {
         ...
         if (chain == null) {
            try {
               ...
               LogUtil.error(Env.CLIENT, "Failed to load gravity red shader", var9);
               chain = null;
               return;
            }
         }
