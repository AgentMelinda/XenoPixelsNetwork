...
public final class StoryNotificationManager {
      ...
      if (mc.player != null) {
         ...
         switch (message.getEventType()) {
            case QUEST_STARTED: {
               ...
               description = (Component)(quest != null ? toComponent(quest.getTitle()) : Component.literal(message.getQuestId()));
            ...
            case QUEST_FAILED: {
               ...
               description = quest != null
                  ? Component.translatable("toast.dragonminez.story.quest_failed.desc", new Object[]{toComponent(quest.getTitle())})
                  : Component.translatable("toast.dragonminez.story.quest_failed.desc", new Object[]{Component.literal(message.getQuestId())});
            ...
            case QUEST_COMPLETE: {
               ...
               description = quest != null
                  ? Component.translatable("toast.dragonminez.story.quest_complete.desc", new Object[]{toComponent(quest.getTitle())})
                  : Component.translatable("toast.dragonminez.story.quest_complete.desc", new Object[]{Component.literal(message.getQuestId())});
   ...
   private static Component resolveObjectiveText(Minecraft mc, StoryToastS2C message, Quest quest) {
      if (quest == null) {
         return Component.literal(message.getQuestId());
      } else {
         ...
         if (idx >= 0 && idx < quest.getObjectives().size()) {
            ...
            if (progress < 0 || required < 0) {
               int[] fallbackProgress = new int[]{0};
               int[] fallbackRequired = new int[]{objective.getRequired()};
            ...
            return Component.translatable("toast.dragonminez.story.objective_complete.desc", new Object[]{objectiveText, progress, required});
         } else {
