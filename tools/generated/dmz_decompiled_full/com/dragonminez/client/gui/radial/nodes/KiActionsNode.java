...
public class KiActionsNode extends CategoryNode {
   ...
   protected List<RadialNode> buildChildren(StatsData stats) {
      ...
      out.add(
         new SkillToggleNode(
            Component.translatable("skill.dragonminez.aurastatus"),
            icon("aura"),
      ...
      out.add(
         new SkillToggleNode(
            Component.translatable("skill.dragonminez.friendlyfist"),
            icon("friendlyfist"),
            s -> s.getSkills().hasSkill("kicontrol"),
      ...
      out.add(
         new SkillToggleNode(
            Component.translatable("skill.dragonminez.kiprotection"),
            icon("kiprotection"),
      ...
      out.add(
         new SkillToggleNode(
            Component.translatable("skill.dragonminez.ki_infusion"),
            icon("kifist"),
