...
public class KiExplosionVisualRenderer extends EntityRenderer<KiExplosionVisualEntity> {
   private static final ResourceLocation TEXTURE_EXPLOSION = ResourceLocation.fromNamespaceAndPath("dragonminez", "textures/entity/ki/ki_laser.png");

   public KiExplosionVisualRenderer(Context context) {
      super(context);
   }
