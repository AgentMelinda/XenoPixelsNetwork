...
public class QuestNPCRenderer extends GeoEntityRenderer<QuestNPCEntity> {
   public QuestNPCRenderer(Context renderManager) {
      super(renderManager, new QuestNPCModel());
      this.shadowRadius = 0.4F;
   }

   public RenderType getRenderType(QuestNPCEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
